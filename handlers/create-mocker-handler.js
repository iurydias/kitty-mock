      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          ...
          mocker.runServer().then(function () {
            mocker.addRoute({
              path: '/=%5E.%5E=/route', method: methods_consts_1.GET, handler: {
                handle: function (req) {
                  return new Promise(function (resolve) {
            ...
            mocker.addRoute({
              path: '/=%5E.%5E=/route', method: methods_consts_1.DELETE, handler: {
                handle: function (req) {
                  return new Promise(function (resolve) {
                    resolve({ code: 204, jsend: undefined })
            ...
            resolve({
              code: 200,
              jsend: get_jsend_1['default'](200, JSON.stringify(mockerInfoResponse), 'mocker successfully created')
            })
